...
object1 init a =
  let
    ...
    de ( name, _, serializer ) =
      (name := serializer.decoder)
...
object4 : m -> SerializeData m a -> SerializeData m b -> SerializeData m c -> SerializeData m d -> Serializer m
...
object5 : m -> SerializeData m a -> SerializeData m b -> SerializeData m c -> SerializeData m d -> SerializeData m e -> Serializer m
...
object6 : m -> SerializeData m a -> SerializeData m b -> SerializeData m c -> SerializeData m d -> SerializeData m e -> SerializeData m f -> Serializer m
object6 init a b c d e f =
  let
    fo ( _, focus, _ ) =
      focus
    ...
    en =
      encodeObject
  in
    { encode = \m -> E.object [ en a m, en b m, en c m, en d m, en e m, en f m ]
    , decoder =
        D.object6
          (\x y z i j k ->
            set (fo a) x
